...
const PARTICIPANTS = [
  ...
  { name: "Гулина Калыгулова",         photo: "./assets/media/members/2 ГУЛИНА.webp" },
  { name: "Ишенбек уулу Темирлан",     photo: "./assets/media/members/3 Ишенбек уулу Темирлан.webp" },
  { name: "Кадыралиев Нурсултан",   photo: "./assets/media/members/4 Кадыралиев Нурсултан.webp" },
  { name: "Калиева Бермет",             photo: "./assets/media/members/5 Калиева Бермет.webp" },
  { name: "Канат уулу Жанат",      photo: "./assets/media/members/6 Канат уулу Жанат.webp" },
  { name: "Миталип уулу Эсенбек",      photo: "./assets/media/members/7 Миталип уулу Эсенбек.webp" },
  { name: "Токтоболот уулу Улукбек", photo: "./assets/media/members/8 Токтоболот уулу Улукбек.webp" },
  { name: "Тумөнбаева Нуржан",     photo: "./assets/media/members/9 Туменбаева Нуржан.webp" },
